      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="mb-8">
          ...
          <div className="text-center">
            <div className="flex items-center justify-center space-x-3 mb-4">
              ...
              <h1 className="text-4xl font-bold text-gradient">Novidades</h1>
            </div>
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              Confira os produtos mais recentes adicionados à nossa loja digital.
            </p>
          </div>
        </div>
        ...
        {newProducts.length > 0 ? (
          ...
          <div className="text-center py-20">
            ...
            <h3 className="text-xl font-semibold mb-2">Nenhum produto novo</h3>
            <p className="text-muted-foreground mb-4">
              No momento não temos produtos novos. Volte em breve para conferir as novidades!
            </p>
            <Link to="/loja">
